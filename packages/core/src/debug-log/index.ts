 ...
 *
 * This writes logs to ~/.agent/cli-debug.log, avoiding stdout/stderr
...
const DEBUG_LOG_PATH = path.join(os.homedir(), ".agent", "cli-debug.log")
 ...
 * Writes timestamped entries to ~/.agent/cli-debug.log
